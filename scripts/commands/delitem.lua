...
function onTrigger(player, name, target)
    ...
    for i = tpz.inv.INVENTORY, tpz.inv.WARDROBE8  do -- inventory locations enums
        ...
        if (i == tpz.inv.WARDROBE8) then -- Wardrobe 8 is the last inventory location, if it reaches this point then the player does not have the item anywhere.
