...
function onMobFight(mob, target)
    ...
    if StartTrampling == 1 then
        if TrackingTarget == 0 then
            ...
            if RNG == 1 then
                mob:pathTo(478, -6, -423) -- Jugner
            elseif RNG == 2 then
                mob:pathTo(221, 0, -517) -- South
            elseif RNG == 3 then
                mob:pathTo(80, -56, 114) -- NorthWest
            elseif RNG == 4 then
                mob:pathTo(398, -59, 457) -- North
            elseif RNG == 5 then
                mob:pathTo(634, -49, 162) -- NorthEast
            elseif RNG == 6 then
                mob:pathTo(150, -11, -391) -- West
            end
        end
