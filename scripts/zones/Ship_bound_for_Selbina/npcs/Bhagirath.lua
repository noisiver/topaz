...
-----------------------------------
local messages = -- TODO: Nearing mesage IDs
{
    [tpz.transport.message.NEARING] = ID.text.NEARING_SELBINA,
    [tpz.transport.message.DOCKING] = ID.text.DOCKING_IN_SELBINA
}

function onSpawn(npc)
    npc:addPeriodicTrigger(tpz.transport.message.NEARING, tpz.transport.messageTime.NEARING, tpz.transport.epochOffset.NEARING)
