...
enum SUBSKILLTYPE
{
    ...
    SUBSKILL_SILAS = 67,
    SUBSKILL_TOLOI = 68,
    //SUBSKILL_Roche = 69,  Airy Broth
    //SUBSKILL_Caroline = 70,  Aged Humus
    //SUBSKILL_Ken = 71, Blackwater Broth
    //SUBSKILL_Jedd = 72,  Crackling Broth
    //SUBSKILL_Annabelle = 73,  Creepy Broth
    //SUBSKILL_Waluis = 74,  Crumbly Soil
    //SUBSKILL_Slime = 75,  Decaying Broth
    //SUBSKILL_Patrice = 76,  Putrescent Broth
    //SUBSKILL_Arthur = 77, Dire Broth
    //SUBSKILL_Candi = 78,  Electrified Broth
    //SUBSKILL_Honey = 79,  Bug-Ridden Broth
    // STOPPED HERE
    //SUBSKILL_Lynx = 80, Frizzante Broth
    //SUBSKILL_Gaston = 81,  Spumante Broth
    //SUBSKILL_Kiyomaro = 82,  Fizzy Broth
    //SUBSKILL_Vickie = 83,  Tant. Broth
    //SUBSKILL_Alice = 84,  Furious Broth
    //SUBSKILL_Storm = 85,  Insipid Broth
    //SUBSKILL_Iyo = 86,  Deepwater Broth
    //SUBSKILL_Patrick = 87,  Livid Broth
    //SUBSKILL_Shizuna = 88,  Lyrical Broth
    //SUBSKILL_Randy = 89,  Meaty Broth
    //SUBSKILL_Lynn = 90,  Muddy Broth
    //SUBSKILL_Percival = 91, Pale Sap
    //SUBSKILL_Acuex = 92,  Poisonous Broth
    //SUBSKILL_Bredo = 93,  Venomous Broth
    //SUBSKILL_Weevil = 94,  Pristine Sap
    //SUBSKILL_Angelina = 95,  Truly Pristine Sap
    //SUBSKILL_Reinhard = 96,  Rapid Broth
    //SUBSKILL_Hermes = 97,  Saline Broth
    //SUBSKILL_Porter_Crab = 98,  Rancid Broth
    //SUBSKILL_Edwin = 99, Pungent Broth
    //SUBSKILL_Ibuki = 100,  Salubrious Broth
    //SUBSKILL_Zhivago = 101, Windy Greens
    //SUBSKILL_Malfik = 102,  Shimmering Broth
    //SUBSKILL_Angus = 103,  Ferm. Broth
    //SUBSKILL_Xerin = 104,  Spicy Broth
    //SUBSKILL_Bertha = 105,  Bubbly Broth
    //SUBSKILL_Spider = 106,  Sticky Webbing
    //SUBSKILL_Hachirobe = 107, Slimy Webbing
    //SUBSKILL_Colibri = 108,  Sugary Broth
    //SUBSKILL_Leera = 109,  Glazed Broth
    //SUBSKILL_Dortwin = 110,  Swirling Broth
    //SUBSKILL_Peter = 111,  Vis. Broth
    //SUBSKILL_Henry = 112,  Trans. Broth
    //SUBSKILL_Hippogryph = 113,  Turpid Broth
    //SUBSKILL_Roland = 114,  Feculent Broth
    //SUBSKILL_Mosquito = 115,  Wetlands Broth
    //SUBSKILL_Yoko = 116,  Heavenly Broth
    //SUBSKILL_Glenn = 117,  Wispy Broth
    //SUBSKILL_Yellow_Beetle = 118,  Zestful Sap
    //SUBSKILL_Sefina = 119,  Gassy Sap
};
