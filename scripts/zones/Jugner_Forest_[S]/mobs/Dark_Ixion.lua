...
function onMobFight(mob, target)
    ...
    if StartTrampling == 1 then
        if TrackingTarget == 0 then
            ...
            if RNG == 1 then
                mob:pathTo(321.000, 2.400, 420.000) -- Batallia
            elseif RNG == 2 then
                mob:pathTo(-431, -0, -428) -- SouthWest
            elseif RNG == 3 then
                mob:pathTo(-328, -0, -30) -- West
            elseif RNG == 4 then
                mob:pathTo(-312, 0, 194) -- NorthWest
            elseif RNG == 5 then
                mob:pathTo(238, -0, -5) -- East
            elseif RNG == 6 then
                mob:pathTo(278, -7, -471) -- SouthEast
            end
        end
