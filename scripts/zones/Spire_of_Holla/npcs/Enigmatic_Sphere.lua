...
local loot =
{
    ...
    [769] =
    {
        ...
        },
        {
            ...
            {itemid = 1799, droprate =  60}, -- Punctilious
            {itemid = 1798, droprate =  60}, -- Vernal
            {itemid = 1802, droprate =  60}, -- Audacious
            {itemid = 1807, droprate =  60}, -- Vivid
            {itemid = 1810, droprate =  60}, -- Endearing
        },
    },
}
