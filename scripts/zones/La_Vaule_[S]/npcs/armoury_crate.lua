...
local loot =
{
    ...
    [1308] =
    {
        ...
        {
            {itemid =  16158, droprate =  500}, -- gnadbhods_helm
            {itemid =  16004, droprate =  500}, -- supremacy_earring
        },
        {
            {itemid =  16356, droprate =  500}, -- nimues_tights
            {itemid =  17758, droprate =  500}, -- ruler
            {itemid =  15831, droprate =  500}, -- fenian_ring
        },
        {
    ...
    [1311] =
    {
        ...
        {
            {itemid =  19029, droprate =  500}, -- Brave Grip
            {itemid =  19030, droprate =  500}, -- Wise Strap
        },
        {
            {itemid =    0,   droprate =  250}, -- Nothing
            {itemid =  16241, droprate =  250}, -- Cuchulain's Mantle 
            {itemid =  15016, droprate =  250}, -- Orcish Gauntlets
            {itemid =  15918, droprate =  250}, -- Witch Sash
        },
        {
            {itemid = 654, droprate = 25},   -- Darksteel Ingot
            {itemid = 797, droprate = 25},   -- Painite
