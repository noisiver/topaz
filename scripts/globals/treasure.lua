    ...
    [tpz.treasure.type.CHEST] =
    {
        zone =
        {
            [tpz.zone.PSOXJA] = -- 9
            {
                ...
                gil = {0.750, 5200, 12500},
                gem = {0.050, 811, 798, 815, 790, 799, 788, 808},
                item = {0.200, 18014}, -- Odorous Knife
            },
            [tpz.zone.OLDTON_MOVALPOLOS] = -- 11
            {
                ...
                gil = {0.731, 3200, 6400},
                gem = {0.069, 811, 808, 796, 799, 788, 815, 798},
            },
            ...
            [tpz.zone.PALBOROUGH_MINES] = -- 143
            {
                ...
                gil = {0.455, 840, 1600},
                gem = {0.066, 795, 800, 814, 807, 806, 809},
                item = {0.459, 14206},
            },
            ...
            [tpz.zone.BEADEAUX] = -- 147
            {
                ...
                gil = {0.442, 3440, 9000},
                gem = {0.060, 811, 790, 796, 798, 808, 815},
                item = {0.458, 13230},
            },
            [tpz.zone.DAVOI] = -- 149
            {
                ...
                gil = {0.429, 3060, 6320},
                gem = {0.067, 811, 790, 808, 796, 799, 788, 815, 798},
                item = {0.464, 13515},
            },
            [tpz.zone.CASTLE_OZTROJA] = -- 151
            {
                ...
                gil = {0.440, 3200, 6320},
                gem = {0.060, 811, 790, 808, 796, 788, 807, 815, 798},
                item = {0.480, 13840},
            },
            [tpz.zone.MIDDLE_DELKFUTTS_TOWER] = -- 157
            {
                ...
                gil = {0.455, 2450, 7000},
                gem = {0.061, 814, 800, 809, 795, 796, 799, 806},
                item = {0.484, 18090},
            },
            ...
            [tpz.zone.CASTLE_ZVAHL_BAILEYS] = -- 161
            {
                ...
                gil = {0.456, 5000, 13950},
                gem = {0.060, 811, 790, 808, 788, 799, 815},
                item = {0.480, 13516},
            },
            [tpz.zone.CASTLE_ZVAHL_KEEP] = -- 162
            {
                ...
                gil = {0.456, 5000, 10000},
                gem = {0.060, 798, 790, 808, 788, 815, 796},
                item = {0.480, 13516},
            },
            [tpz.zone.SEA_SERPENT_GROTTO] = -- 176
            {
                ...
                gil = {0.929, 3355, 8900},
                gem = {0.061, 811, 808, 790, 796, 815, 788, 799, 798},
            },
            [tpz.zone.KING_RANPERRES_TOMB] = -- 190
            {
                ...
                gil = {0.454, 390, 1300},
                gem = {0.060, 814, 800, 809, 795, 807, 806},
                item = {0.480, 12799},
            },
            ...
            [tpz.zone.ORDELLES_CAVES] = -- 193
            {
                ...
                gil = {0.450, 1800, 3600},
                gem = {0.060, 800, 809, 806, 807, 796, 795, 814, 799},
                item = {0.486, 17839},
            },
            ...
            [tpz.zone.THE_ELDIEME_NECROPOLIS] = -- 195
            {
                ...
                gem = {0.060, 811, 808, 796, 799, 815, 790},
                item = {0.474, 16771},
            },
            [tpz.zone.GUSGEN_MINES] = -- 196
            {
                ...
                gil = {0.452, 1980, 3600},
                gem = {0.060, 806, 809, 814, 800, 796, 795, 799},
                item = {0.485, 18212, 17426}, 
            },
            [tpz.zone.CRAWLERS_NEST] = -- 197
            {
                ...
                gil = {0.454, 4702, 10000},
                gem = {0.060, 811, 790, 808, 796, 799, 788, 815, 798},
                item = {0.484, 16710},
            },
            ...
            [tpz.zone.FEIYIN] = -- 204
            {
                ...
                gil = {0.449, 4050, 7920},
                gem = {0.061, 811, 790, 808, 796, 799, 788, 815, 798},
                item = {0.480, 13231},
            },
    ...
    [tpz.treasure.type.COFFER] =
    {
        zone =
        {
            ...
            [tpz.zone.NEWTON_MOVALPOLOS] = -- 12
            {
                ...
                gil = {0.850, 9800, 19180},
                gem = {0.050, 791, 797, 784, 803, 805, 801, 802},
                item = {0.100, 15744}, -- Bowman's Ledelsens
            },
            [tpz.zone.RUAUN_GARDENS] = -- 130
            {
                ...
                gil = {0.850, 9576, 19460},
                gem = {050, 791, 801, 810, 784, 802, 797, 805, 803},
                item = {0.100, 16284}, -- Caract Choker
            },
            [tpz.zone.BEADEAUX] = -- 147
            {
                treasureLvl = 53,
                ...
                gil = {0.455, 4700, 25000},
                gem = {0.060, 791, 801, 802, 797, 788, 803, 805, 810, 784},
                item = {0.485, 4820},
            },
            [tpz.zone.MONASTIC_CAVERN] = -- 150
            {
                ...
                gil = {0.458, 7320, 14400},
                gem = {0.055, 801, 810, 784, 802, 797, 803},
                item = {0.487, 13398}, -- Physical Earring
            },
            [tpz.zone.CASTLE_OZTROJA] = -- 151
            {
                treasureLvl = 53,
                ...
                gil = {0.452, 7320, 18000},
                gem = {0.064, 791, 801, 810, 784, 802, 797, 803, 805},
                item = {0.484, 13548},
            },
            [tpz.zone.THE_BOYAHDA_TREE] = -- 153
            {
                ...
                gil = {0.453, 7110, 20520},
                gem = {0.062, 791, 801, 810, 784, 802, 803, 805, 797},
                item = {0.485, 4447},
            },
            [tpz.zone.TEMPLE_OF_UGGALEPIH] = -- 159
            {
                ...
                gil = {0.453, 7320, 14400},
                gem = {0.064, 797, 801, 810, 802, 805, 803},
                item = {0.485, 14756}, -- Accurate Earring
            },
            [tpz.zone.DEN_OF_RANCOR] = -- 160
            {
                ...
                gil = {0.455, 8000, 16770},
                gem = {0.060, 797, 805},
                item = {0.485, 3341}, -- Beastly shank (Behemoth Pop)
            },
            [tpz.zone.CASTLE_ZVAHL_BAILEYS] = -- 161
            {
                treasureLvl = 53,
                ...
                gil = {0.455, 6300, 26880},
                gem = {0.060, 791, 801, 810, 784, 802, 797, 803, 805},
                item = {0.485, 4995},
            },
            [tpz.zone.TORAIMARAI_CANAL] = -- 169
            {
                ...
                gil = {0.455, 7440, 14280},
                gem = {0.060, 791, 801, 784, 802, 797, 803, 805},
                item = {0.485, 3339}, -- Jug Of Honey Wine (Fafnir Pop)
            },
            ...
            [tpz.zone.SEA_SERPENT_GROTTO] = -- 176
            {
                ...
                gil = {0.950, 6145, 19580},
                gem = {0.060, 791, 810, 784, 802, 803, 797, 801},
            },
            [tpz.zone.VELUGANNON_PALACE] = -- 177
            {
                ...
                gil = {0.850, 9940, 18900},
                gem = {0.050, 791, 805},
                item = {0.100, 15517}, -- Sniper's Collar
            },
            [tpz.zone.THE_ELDIEME_NECROPOLIS] = -- 195
            {
                treasureLvl = 53,
                ...
                gil = {0.450, 7590, 18039},
                gem = {0.060, 801, 810, 802, 797, 803},
                item = {0.480, 4175}, -- Vile Elixir +1
            },
            [tpz.zone.CRAWLERS_NEST] = -- 197
            {
                treasureLvl = 53,
                ...
                gil = {0.457, 6040, 12100},
                gem = {0.067, 791, 801, 784, 797, 805, 803},
                item = {0.486, 4173}, -- Hi-Reraiser
            },
            [tpz.zone.GARLAIGE_CITADEL] = -- 200
            {
                treasureLvl = 53,
                ...
                gil = {0.455, 6668, 18700},
                gem = {0.065, 801, 784, 802},
                item = {0.485, 13977},
            },
            [tpz.zone.IFRITS_CAULDRON] = -- 205
            {
                ...
                gil = {0.455, 7200, 21060},
                gem = {0.060, 802, 797, 803, 801, 810, 791},
                item = {0.485, 3343}, -- Blue Pondweed (Adamantoise Pop)
            },
            [tpz.zone.QUICKSAND_CAVES] = -- 208
            {
                ...
                gil = {0.850, 6160, 16100},
                gem = {0.050, 791, 801, 810, 784, 797, 803},
                item = {0.100, 15042}, -- Gothic Gauntlets
            },
        },
    },
}
