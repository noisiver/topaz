...
--  Ruinous Scythe
--
--  Description: Deals damage in a threefold attack. Additional effect: Stun + Max HP down
--  Type: Physical
--  Utsusemi/Blink absorb: 4 shadows
--  Range: Melee
--  Notes: Max HP down can scale up to -75%
---------------------------------------------
...
function onMobWeaponSkill(target, mob, skill)
    ...
    local dmg = MobFinalAdjustments(info.dmg, mob, skill, target, tpz.attackType.PHYSICAL, tpz.damageType.SLASHING, MOBPARAM_4_SHADOW)

    local typeEffect = tpz.effect.MAX_HP_DOWN
    local power = math.random(10, 75)
	local tick = 0
	local duration = 300
