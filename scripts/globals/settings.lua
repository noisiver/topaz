...
EXP_RATE        = 0.000 -- Multiplies exp earned from fov and quests.
...
-- DYNAMIS SETTINGS
BETWEEN_2DYNA_WAIT_TIME  = 11       -- Hours before player can re-enter Dynamis. Default is 1 Earthday (24 hours).
...
FRIGICITE_TIME  = 600    -- When OLDSCHOOL_G2 is enabled, this is the time (in seconds) you have from killing Boreal NMs to click the "???" target.
...
ABSORB_SPELL_AMOUNT = 18 -- how much of a stat gets absorbed by DRK absorb spells - expected to be a multiple of 8.
