    ...
    [tpz.treasure.type.COFFER] =
    {
        zone =
        {
            ...
            [tpz.zone.DEN_OF_RANCOR] = -- 160
            {
                ...
                gil = {0.525, 8000, 16770},
                gem = {0.060, 797, 805},
                item = {0.525, 3341}, -- Beastly shank (Behemoth Pop)
            },
            [tpz.zone.CASTLE_ZVAHL_BAILEYS] = -- 161
            {
                treasureLvl = 53,
            ...
            [tpz.zone.TORAIMARAI_CANAL] = -- 169
            {
                ...
                gil = {0.525, 7440, 14280},
                gem = {0.060, 791, 801, 784, 802, 797, 803, 805},
                item = {0.525, 3339}, -- Jug Of Honey Wine (Fafnir Pop)
            },
            ...
            [tpz.zone.IFRITS_CAULDRON] = -- 205
            {
                ...
                gil = {0.525, 7200, 21060},
                gem = {0.060, 802, 797, 803, 801, 810, 791},
                item = {0.525, 3343}, -- Blue Pondweed (Adamantoise Pop)
            },
