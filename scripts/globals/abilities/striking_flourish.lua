...
function onUseAbility(player, target, ability)
    if (player:hasStatusEffect(tpz.effect.FINISHING_MOVE_1)) then
        ...
        target:addStatusEffect(tpz.effect.STRIKING_FLOURISH, 5, 0, 180)
    elseif (player:hasStatusEffect(tpz.effect.FINISHING_MOVE_2)) then
        player:delStatusEffectSilent(tpz.effect.FINISHING_MOVE_2)
        target:addStatusEffect(tpz.effect.STRIKING_FLOURISH, 10, 0, 180)
    elseif (player:hasStatusEffect(tpz.effect.FINISHING_MOVE_3)) then
        ...
        target:addStatusEffect(tpz.effect.STRIKING_FLOURISH, 15, 0, 180)
    elseif (player:hasStatusEffect(tpz.effect.FINISHING_MOVE_4)) then
        ...
        target:addStatusEffect(tpz.effect.STRIKING_FLOURISH, 20, 0, 180)
    elseif (player:hasStatusEffect(tpz.effect.FINISHING_MOVE_5)) then
        ...
        target:addStatusEffect(tpz.effect.STRIKING_FLOURISH, 25, 0, 180)
    end
end
