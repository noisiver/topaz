...
function getRangedHitRate(attacker, target, capHitRate, bonus)
    ...
    if attacker:getMainLvl() > target:getMainLvl() then
        ...
        hitdiff = hitrate + math.floor((((acc - eva)) / 2) - (target:getMainLvl() - attacker:getMainLvl())*4)
        firsthit = hitrate + math.floor((((firstacc - eva)) / 2) - (target:getMainLvl() - attacker:getMainLvl())*4)
    end
