...
zones[tpz.zone.KORROLOKA_TUNNEL] =
{
    text =
    {
        ...
        CAREFULLY_DRAW_WATER     = 7332,  -- You carefully draw water stored in the clam into.
        FLASK_FEELS_LIGHT        = 7333,  -- The flask still feels light...
        FLASK_FULL               = 7334,  -- The flask is now full!
        CLAM_EMPTY               = 7335,  -- The clam is empty.
