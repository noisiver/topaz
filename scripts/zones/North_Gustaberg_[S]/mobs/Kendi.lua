...
function onMobFight(mob, target)
    ...
    if (hp < 20) then
        mob:addStatusEffectEx(tpz.effect.COLURE_ACTIVE, tpz.effect.COLURE_ACTIVE, 13, 3, 180, tpz.effect.GEO_MAGIC_DEF_DOWN, 25, tpz.auraTarget.ENEMIES, tpz.effectFlag.AURA)
    end
end
