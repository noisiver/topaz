...
zones[tpz.zone.NAVUKGO_EXECUTION_CHAMBER] =
{
    text =
    {
        ...
        SHAMARHAAN_LET_US_BEGIN = 7614, -- Let us begin.
        SHAMARHAAN_DO_NOT_UNDERESTIMATE = 7615, -- Do not underestimate my automaton's power!
        SHAMARHAAN_NOT_READY    = 7616, -- Unfortunately, it looks like you are still not ready yet...
        SHAMARHAAN_MAGNIFICENT  = 7617, -- Magnificent work...
        SHAMARHAAN_TRICKS       = 7618, -- I've got a few tricks up my own sleeve!
        SHAMARHAAN_LETS_TRY     = 7619, -- Hmm... Let's try this one...
        SHAMARHAAN_FULL_STEAM   = 7620, -- Full steam ahead!
        SHAMARHAAN_NO_DESIRE    = 7621, -- Enough. I have no desire to watch this foolishness all day.
        SHAMARHAAN_UNDERESTIMATED = 7622, -- It looks like I underestimated you!
        SHAMARHAAN_AUTOMATON    = 7623, -- My automaton! Amazing...
        LEVEL_LIMIT_75          = 7624, -- Your level limit is now 75.
        ...
        BCNM_SEALED             = 7253, -- The door is locked.
        BCNM_TESTIMONY          = 7271, -- Your <item> is torn...
        BCNM_CLEARANCE          = 7519, -- Currently, <total> members of your party (including yourself) have clearance to enter the battlefield.
