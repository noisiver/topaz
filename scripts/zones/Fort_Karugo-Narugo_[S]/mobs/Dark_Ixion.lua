...
function onMobFight(mob, target)
    ...
    if Ashed == 0 then -- Failed to hit with stygian ash
        ...
        if RNG == 1 then
            mob:pathTo(-563, -3, -700) -- Saruta
        elseif RNG == 2 then
            mob:pathTo(103, -13, 777) -- Batallia
        end
        ...
        if BattleTime >= RunAwayWait and RunAwayWait > 0 then
            ...
            if RNG == 1 then
                ixion = GetMobByID(17166730) -- Saruta
            elseif RNG == 2  then
                ixion = GetMobByID(17121697) -- Batallia
            end
            ixion:spawn()
            mob:setLocalVar("RunAwayWait", 0)
        end
    ...
    if StartTrampling == 1 then
        if TrackingTarget == 0 then
            ...
            if RNG == 1 then
                mob:pathTo(-563, -3, -700) -- Saruta
            elseif RNG == 2 then
                mob:pathTo(103, -13, 777) -- Meriph
            elseif RNG == 3 then
                mob:pathTo(-254, -57, -241)
            elseif RNG == 4 then
                mob:pathTo(203, -51, -204)
            elseif RNG == 5 then
                mob:pathTo(-105, -79, -0)
            elseif RNG == 6 then
                mob:pathTo(94, -61, -304)
            end
        end
