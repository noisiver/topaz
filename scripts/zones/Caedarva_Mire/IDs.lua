...
zones[tpz.zone.CAEDARVA_MIRE] =
{
    text =
    {
        ...
        OMINOUS_PRESENCE         = 8050, -- You sense an ominous presence...
        HEADY_FRAGRANCE          = 8051, -- A heady fragrance of wine pervades the air...
        GLITTERING_FRAGMENTS     = 8052, -- Minute glittering fragments are scattered all over...
        INSECT_WINGS             = 8053, -- Broken shards of of insect wing are scattered all over...
