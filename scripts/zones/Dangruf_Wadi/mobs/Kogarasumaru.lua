...
function onMobFight(mob, target)
    ...
    elseif battletime >= twohourTime and STANCEtank == 0 then
        ...
        player:PrintToPlayer("You cannot withstand my might!",0,"Kogarasumaru")
    ...
    if battletime >= STANCEdps and STANCEtank == 1 then
        ...
        mob:setMod(tpz.mod.HASTE_MAGIC, mob:getMod(tpz.mod.HASTE_MAGIC) - 7500)
        player:PrintToPlayer("Go ahead, try and hit me.",0,"Kogarasumaru")
