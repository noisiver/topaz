...
function onMobRoam(mob)
    --mob:setPos(375.7404,-26.5396,719.6661,130)
    mob:setMobMod(tpz.mobMod.NO_MOVE, 1)
end
...
function onMobFight(mob, target)
    ...
    if (hp < 20) then
        mob:addStatusEffectEx(tpz.effect.COLURE_ACTIVE, tpz.effect.COLURE_ACTIVE, 13, 3, 180, tpz.effect.GEO_SLOW, 2250, tpz.auraTarget.ENEMIES, tpz.effectFlag.AURA)
    end
end
