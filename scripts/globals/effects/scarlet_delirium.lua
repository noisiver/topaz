...
function onEffectGain(target, effect)
    ...
    target:addMod(tpz.mod.HPP, -25)
    target:addMod(tpz.mod.DEFP, -75)
    target:addMod(tpz.mod.UDMGPHYS, 50)
    target:addMod(tpz.mod.UDMGMAGIC, 50)
    target:addMod(tpz.mod.UDMGRANGE, 50)
...
function onEffectLose(target, effect)
    ...
    target:delMod(tpz.mod.HPP, -25)
    target:delMod(tpz.mod.DEFP, -75)
    target:delMod(tpz.mod.UDMGPHYS, 50)
    target:delMod(tpz.mod.UDMGMAGIC, 50)
    target:delMod(tpz.mod.UDMGRANGE, 50)
