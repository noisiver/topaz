...
function onTrigger(player)
    ...
    if (pet and pet:getLocalVar("GodMode") == 0) then
        ...
        pet:delStatusEffectSilent(tpz.effect.MAX_HP_BOOST)
        pet:delStatusEffectSilent(tpz.effect.MAX_MP_BOOST)
        pet:delStatusEffectSilent(tpz.effect.SENTINEL)
        pet:delStatusEffectSilent(tpz.effect.MIGHTY_STRIKES)
        pet:delStatusEffectSilent(tpz.effect.HUNDRED_FISTS)
        pet:delStatusEffectSilent(tpz.effect.CHAINSPELL)
        pet:delStatusEffectSilent(tpz.effect.PERFECT_DODGE)
        pet:delStatusEffectSilent(tpz.effect.INVINCIBLE)
        pet:delStatusEffectSilent(tpz.effect.MANAFONT)
        pet:delStatusEffectSilent(tpz.effect.REGAIN)
        pet:delStatusEffectSilent(tpz.effect.REFRESH)
