...
zones[tpz.zone.HALVUNG] =
{
    text =
    {
        ...
        OPERATING_LEVER_START   = 7894, -- <player> begins pushing on the lever!
        OPERATING_LEVER_FAIL    = 7897, -- <player> releases the lever.
        OPERATING_LEVER_SUCCESS = 8040, -- You lift the lever with all your might!
