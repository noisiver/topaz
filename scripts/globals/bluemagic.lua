...
function BluePhysicalSpell(caster, target, spell, params, tp)
	...
	local bluphysattk = (((caster:getSkillLevel(tpz.skill.BLUE_MAGIC) + 8 + (caster:getStat(tpz.mod.STR) * 0.75) + caster:getMod(tpz.mod.ATT)) * (caster:getMod(tpz.mod.ATTP) / 100)) * BluAttkModifier) 
