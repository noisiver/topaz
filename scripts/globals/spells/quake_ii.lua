...
function onSpellCast(caster, target, spell)
    ...
    spellParams.resistBonus = caster:getMerit(tpz.merit.QUAKE_II) * 5
    spellParams.V = 710
    spellParams.V0 = 900
    ...
    spellParams.M200 = 3
    spellParams.I = 780
    spellParams.AMIIburstBonus = caster:getMerit(tpz.merit.QUAKE_II) * 3

    -- no point in making a separate function for this if the only thing they won't have in common is the name
    handleNinjutsuDebuff(caster, target, spell, 30, 60, tpz.mod.WINDRES)
