...
function onEffectGain(target, effect)
    ...
    target:addMod(tpz.mod.FOOD_ATT_CAP, 105)
    target:addMod(tpz.mod.FOOD_RATTP, 16)
    target:addMod(tpz.mod.FOOD_RATT_CAP, 105)
...
function onEffectLose(target, effect)
    ...
    target:delMod(tpz.mod.FOOD_ATT_CAP, 105)
    target:delMod(tpz.mod.FOOD_RATTP, 16)
    target:delMod(tpz.mod.FOOD_RATT_CAP, 105)
