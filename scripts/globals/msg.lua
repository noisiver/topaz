...
tpz.msg.basic =
{
    ...
    MAGIC_BURST_BREATH     = 265, -- "Magic Burst!" BLU breaths
    ...
    SELF_HEAL_SECONDARY    = 263, -- <target> recovers <amount> HP. Used for Curaga.
    ...
    SKILL_MISS             = 188, -- Mob TP move miss / resist message.
