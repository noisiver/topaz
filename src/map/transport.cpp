...
void Transport_Ship::setVisible(bool visible)
{
    if (visible)
    {
        ...
        // The effect of 0x8001 appears to be to "stay in place" and not "stand on top of" things, such as the floor -- most likely fixes positions to the exact
        // X/Y/Z coords supplied in 0x00E.
