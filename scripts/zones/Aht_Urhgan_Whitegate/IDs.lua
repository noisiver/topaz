...
zones[tpz.zone.AHT_URHGAN_WHITEGATE] =
{
    text =
    {
        ...
        GATE_IS_FIRMLY_CLOSED         = 1429, -- The gate is firmly closed...≺Prompt≻
        ...
        CONFIRM_ORDER                 = 4598, -- Confirming <assault order>...
        ACCESS_AZOUPH                 = 4606, -- You have not opened a path between the Chamber of Passage and the Azouph Isle staging point (Leujaoam Sanctum).Unable to use runic portal.
        ACCESS_MAMOOL                 = 4607, -- You have not opened a path between the Chamber of Passage and the Mamool Ja staging point (Mamool Ja Training Grounds).Unable to use runic portal.
        ACCESS_LEBROS                 = 4608, -- You have not opened a path between the Chamber of Passage and the Halvung staging point (Lebros Caverns). Unable to use runic portal.
        ACCESS_PERIQIA                = 4609, -- You have not opened a path between the Chamber of Passage and the Dvucca Isle staging point (Periqia).Unable to use runic portal.
        ACCESS_ILRUSI                 = 4610, -- You have not opened a path between the Chamber of Passage and the Ilrusi Atoll staging point.Unable to use runic portal.
        ACCESS_NYZUL                  = 4611, -- You have not opened a path between the Chamber of Passage and the Nyzul Isle staging point.Unable to use runic portal.
        ...
        RYTAAL_CANCEL_MISSION         = 5652, -- Cancel the application? Yes or No. (Options Menu?)
        RYTAAL_APPLICATION_CANCELLED  = 5653, -- Your applicaiton has been cancelled. Please take your (787 army ID tag KI)
        ...
        RYTAAL_NYZUL_COMPLETE         = 6178, -- Congratulations. Please speak to Sorrowful Sage to confirm your current number of Nyzul tokens.
        RYTAAL_NYZUL_FAIL             = 6179, -- Your mission was not successful.  I regret to inform you that the Imperial Army does not officially recognize your efforts within this Assault area.
        IMPERIAL_STANDING_INCREASED   = 6820, -- Your imperial standing has increased!
        PAY_DIVINATION                = 8772, -- You pay 1000 gil for the divination.
        ...
        RETRIEVE_DIALOG_ID            = 13518, -- You retrieve <item> from the porter moogle's care.
        LS_CONCIERGE_LISTING_CANCEL   = 14311, -- It was my pleasure to meet with you this fine day. May you encounter many friendly faces throughout your travels.
        LS_CONCIERGE_SAME_DAY         = 14315, -- In the interest of fairness, I am unable to distribute multiple linkpearls to someone on the same day. Please come back tomorrow.
        LS_CONCIERGE_REGISTERED1      = 14363, -- Your registration is officially complete.
        LS_CONCIERGE_REGISTERED2      = 14364, -- May your journeys lead you to many as-yet-unmet friends, and may the bonds you forge last a lifetime.
        LS_CONCIERGE_ALREADY_LISTED   = 14365, -- Another member of that linkshell currently has an active registration. Please wait until that registration expires and try again.
        ...
        BESIGED_RECHARGE              = 9862, -- You do not possess the ≺Numeric Parameter 1≻ ≺Singular/Plural Choice (Parameter 1)≻[Imperial Standing credit/Imperial Standing credits] required to fully recharge the ≺Possible Special Code: 01≻≺Possible Special Code: 05≻#≺BAD CHAR: 8280≻≺BAD CHAR: 80≻≺BAD CHAR: 80≻.≺Prompt≻
