...
struct Triangle
{
    ...
    {
        return BoundingBox{
            std::min(std::min(vertices[0].x, vertices[1].x), vertices[2].x), std::max(std::max(vertices[0].x, vertices[1].x), vertices[2].x),
            std::min(std::min(vertices[0].y, vertices[1].y), vertices[2].y), std::max(std::max(vertices[0].y, vertices[1].y), vertices[2].y),
            std::min(std::min(vertices[0].z, vertices[1].z), vertices[2].z), std::max(std::max(vertices[0].z, vertices[1].z), vertices[2].z),
        };
    }
