...
local itemList =
{
    ...
    { armor = tpz.items.DREAM_PANTS, coins = 35, egg = tpz.items.D_EGG },
    ...
    { armor = tpz.items.APURURU_UNITY_SHIRT, coins = 35, egg = tpz.items.A_EGG },
    { armor = tpz.items.MAAT_UNITY_SHIRT, coins = 40, egg = tpz.items.M_EGG },
    { armor = tpz.items.ALDO_UNITY_SHIRT, coins = 30, egg = tpz.items.A_EGG },
    ...
    { armor = tpz.items.AGENT_COAT, coins = 40, egg = tpz.items.A_EGG },
