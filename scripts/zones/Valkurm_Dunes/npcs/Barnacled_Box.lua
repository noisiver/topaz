...
local sharedLoot = {
    ...
    item1 =
    {
        [887]   = 125, -- Coral Fragment
        [17006] = 125, -- Drill Calamary 
        [17007] = 125, -- Dwarf Pugil 
        [1587]  = 125, -- HQ Pugil Scales 
        [624]   = 125, -- Pamtam Kelp 
        [1893]  = 125, -- Salinator 
        [4484]  = 125, -- Shall Shell 
        [4288]  = 125, -- Zebra Eel 
    },
    item2 =
    {
        [688]   = 400, -- Arrowwood Log
        [4580]  = 100, -- Butterfly Coral
        [887]   = 100, -- Coral Fragment
        [17006] = 100, -- Drill Calamary
