...
function onEffectGain(target, effect)
    ...
    target:addPetMod(tpz.mod.FOOD_ACCP, 15)
    target:addPetMod(tpz.mod.FOOD_ACC_CAP, 72)
    target:addPetMod(tpz.mod.FOOD_RACCP, 15)
    target:addPetMod(tpz.mod.FOOD_RACC_CAP, 72)
end
