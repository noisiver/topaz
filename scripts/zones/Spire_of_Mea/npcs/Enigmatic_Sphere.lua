...
local loot =
{
    ...
    [833] =
    {
        ...
        },
        {
            ...
            {itemid = 1801, droprate =  60}, -- Solemn
            {itemid = 1804, droprate =  60}, -- Valiant
            {itemid = 1806, droprate =  60}, -- Pretentious
            {itemid = 1809, droprate =  60}, -- Malicious
            {itemid = 1812, droprate =  60}, -- Pristine
        },
    },
}
