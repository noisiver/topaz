    ...
    [tpz.helm.type.EXCAVATION] =
    {
        ...
        zone =
        {
            ...
            [tpz.zone.KORROLOKA_TUNNEL] =
            {
                ...
                points =
                {
                    {-343.873,  -7.293,   90.243}, -- good
                    {-329.9295,  -5.5000,  -56.9871},
                    {-184.039,  -7.080,   79.053}, -- good
                    {-162.855,  -7.433,  135.520}, -- good
                    {-146.129,  -0.971,  -82.968}, -- good
                    {-26.0642,  -0.8830,  -56.9122},  -- maybe wrong change 
                    {-110.8670,  -1.1475,  51.2364},
                    {16.8601,  -1.7100,  24.3936},
                    {137.2639,  0.1205,  71.5424},
                    {-354.4418,  -0.0869,  134.1241},
                    {-24.3424,  -6.9848,  108.3265},
                    {-250.4095,  -4.8236,  90.9905},
                    {-395.2122,  -1.8096,  103.8853},
                    {-392.9190,  -0.3871,  134.3906},
                    {-342.7540,  -5.8496,  165.1839},
                    { -12.104,  -6.361,   95.735}, -- good
                    {  61.417,   0.342,  -29.337}, -- good
                    {  61.890,   0.012,   90.298}, -- good
                },
            },
            [tpz.zone.MAZE_OF_SHAKHRAMI] =
            {
                ...
                --    {-109.760,   0.277,  -35.497},
                    { -95.072,   0.407,  -27.887}, -- good
                --    { -56.496,  -4.040,   14.833}, 
                    { -37.038,  -4.160,    8.707}, -- good
                --    {  82.317,   0.939,   57.508},
                    { -153.6647,   0.1838,   22.6689},
                    { 114.1312,   0.000,  78.5475},
                    { 233.929,   0.307,   31.796}, -- good
                    { 405.2486,  -0.2894, -63.9196},
                    { 255.110,   0.364, -169.030}, -- good
                    { 255.750,  -0.179, -144.886}, -- good
                    { 405.577,  -0.284,  -44.539}, -- good
                },
            },
        },
    },
    ...
    [tpz.helm.type.MINING] =
    {
        ...
        zone =
        {
            ...
            [tpz.zone.GUSGEN_MINES] =
            {
                ...
                points =
                {
                    {-172.555,  -0.330,  303.216}, -- good
                --    {-171.214,  -0.100,  376.661},
                    {-161.341, -24.382,  222.992}, -- good
                    {-145.420, -28.425,  326.760}, -- good
                    {-137.089, -40.658,  150.613}, -- good
                    {-107.372,  -0.380,  256.981}, -- {R}H-8 good
                    { -64.416, -40.104,  253.775}, -- good
                --    { -26.623, -60.805, -141.508},
                    { -24.341, -60.806, -169.115}, -- {R}G-8 Good
                    { -13.810, -40.108,  -87.118}, -- {R}G-7 good
                    { -10.364, -40.028,  -84.169}, -- good
                --    {  27.651, -40.074,   62.101},
                    {  31.350, -41.101,  195.396}, -- {R}H-6 good
                    {  71.523, -60.258, -174.060}, -- good
                    {  92.931, -60.659, -224.312}, -- good
                    { 100.512, -41.629,  209.397}, -- {R}I-6 good
                    { 145.349, -40.450,   24.710}, -- {R}I-8 good
                    { 155.746, -20.678,  216.857}, -- {R}I-9 good
                },
            },
...
local rocks = {769, 772, 770, 771, 773, 774, 776, 775}
